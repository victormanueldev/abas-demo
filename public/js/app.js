...
Vue.component('tareas', __webpack_require__(36));

var app = new Vue({
    el: '#tareas'
});

Vue.component('novedades', __webpack_require__(39));

var novedad = new Vue({
    el: '#novedad'
});

Vue.component('ver-clientes', __webpack_require__(43));

var clientes = new Vue({
    el: '#clientes'
});

Vue.component('notificaciones', __webpack_require__(46));

var notificacion = new Vue({
    el: '#notificacion'
});

Vue.component('documentos', __webpack_require__(49));
...
Component.options.__file = "resources/assets/js/components/tareas.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4695ed2e", Component.options)
  } else {
    hotAPI.reload("data-v-4695ed2e", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        crear: function crear() {
            ...
            axios.post('tareas', this.tarea).then(function (res) {
                _this2.tareas.unshift(res.data);
                _this2.tarea.asunto = '';
            }).catch(function (err) {
                console.log(err);
            });
        },
        completar: function completar(tarea) {
        ...
        eliminar: function eliminar(tarea) {
            var _this3 = this;

            var url = 'tareas/' + tarea.id;
            axios.delete(url).then(function (res) {
                var tareaIndex = _this3.tareas.indexOf(tarea);
                _this3.tareas.splice(tareaIndex, 1);
            }).catch(function (err) {
                console.log(err);
            });
        }
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "ibox-content" }, [
      _c("h2", [_vm._v("Tareas rápidas")]),
      _vm._v(" "),
      _c("small", [_vm._v("Esta es la lista de tareas para hoy")]),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "input-group", staticStyle: { "margin-top": "7px" } },
        [
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.tarea.asunto,
                expression: "tarea.asunto"
              }
            ],
            staticClass: "form-control",
            attrs: { type: "text", placeholder: "Escriba la tarea" },
            domProps: { value: _vm.tarea.asunto },
            on: {
              ...
              input: function($event) {
                ...
                _vm.$set(_vm.tarea, "asunto", $event.target.value)
              }
            }
          }),
      ...
      _c(
        "ul",
        { staticClass: "todo-list m-t small-list" },
        _vm._l(_vm.tareas, function(tarea) {
          return _c("li", { key: tarea.id }, [
            _c(
              "div",
              {
              ...
              [
                  ...
                  directives: [
                    {
                      ...
                      expression: "tarea.completado"
                    }
                  ],
                  attrs: { type: "checkbox", id: "checkbox" },
                  domProps: {
                    checked: Array.isArray(tarea.completado)
                      ? _vm._i(tarea.completado, null) > -1
                      : tarea.completado
                  },
                  on: {
                    ...
                    change: function($event) {
                      ...
                      if (Array.isArray($$a)) {
                        ...
                        if ($$el.checked) {
                          $$i < 0 &&
                            _vm.$set(tarea, "completado", $$a.concat([$$v]))
                        } else {
                          $$i > -1 &&
                            _vm.$set(
                              tarea,
                ...
                _c(
                  "label",
                  {
                    class: { "todo-completed": tarea.completado },
                    staticStyle: { width: "80%" }
                  },
                  [_vm._v(_vm._s(tarea.asunto))]
                ),
                _vm._v(" "),
                _c(
                  "span",
                  {
                    staticClass: "badge badge-plain pull-right",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4695ed2e", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/novedades.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-dc06c484", Component.options)
  } else {
    hotAPI.reload("data-v-dc06c484", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-dc06c484", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/ver-clientes.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2002be8c", Component.options)
  } else {
    hotAPI.reload("data-v-2002be8c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        * Llena el array de personas con la informacion respectiva de la respuesta JSON
         */
        capturarValoresPersonas: function capturarValoresPersonas(cliente) {
        ...
        * Llena el array de Empresa con la informacion respectiva de la respuesta JSON
         */
        capturarValoresEmpresas: function capturarValoresEmpresas(cliente) {
        ...
        * Filtra los clientes por nombre_cliente
        ...
        clientesFiltrados: function clientesFiltrados() {
            ...
            return this.clientes.filter(function (cliente) {
                //Llama a la funcion filter del array
    ...
    _c("div", { staticClass: "col-lg-8" }, [
      _c("div", { staticClass: "ibox" }, [
        _c("div", { staticClass: "ibox-content" }, [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "clients-list" }, [
            _vm._m(2),
            _vm._v(" "),
                    ...
                    _c("div", { staticClass: "table-responsive" }, [
                      _c(
                        ...
                        [
                          _c(
                            "tbody",
                            _vm._l(_vm.clientesFiltrados, function(cliente) {
                              return cliente.cedula
                                ? _c("tr", { key: cliente.id }, [
                                    _c("td", [
                                      _c(
                                        "a",
                                        {
                                          staticClass: "client-link",
                                          attrs: {
                                            "data-toggle": "tab",
                                            href: "#contact-" + cliente.id
                                          },
                                          on: {
                                            click: function($event) {
                                              _vm.capturarValoresPersonas(
                                                cliente
                                              )
                                            }
                                          }
                                        },
                                        [_vm._v(_vm._s(cliente.nombre_cliente))]
                                      )
                                    ]),
                                    _vm._v(" "),
                                    _c("td", [
                                      _vm._v(" C.C. " + _vm._s(cliente.cedula))
                                    ]),
                                    _vm._v(" "),
                                    _vm._m(3, true),
                                    _vm._v(" "),
                          ...
                          _vm._l(_vm.clientesFiltrados, function(cliente) {
                            return cliente.razon_social
                              ? _c("tr", { key: cliente.id }, [
                                  _c("td", [
                                    _c(
                                      "a",
                                      {
                                        ...
                                        attrs: {
                                          "data-toggle": "tab",
                                          href: "#company-" + cliente.id
                                        },
                                        on: {
                                          click: function($event) {
                                            _vm.capturarValoresEmpresas(cliente)
                                          }
                                        }
                                      },
                                  ...
                                  _vm._v(" "),
                                  _c("td", [
                                    _vm._v("NIT " + _vm._s(cliente.nit))
                                  ]),
                                  _vm._v(" "),
                                  _c("td", [
                                    _c("i", { staticClass: "fa fa-flag" }),
                                    _vm._v(
                                      " " + _vm._s(cliente.sector_economico)
                                    )
                                  ]),
                                  _vm._v(" "),
                                  cliente.id <= 4
          ...
          _c("div", { staticClass: "tab-content" }, [
            _c(
              "div",
              {
                ...
                attrs: { id: "contact-" + _vm.personas.id }
              },
              [
                _c("div", { staticClass: "row m-b-lg" }, [
                  _c("div", { staticClass: "col-lg-4 text-center" }, [
                    _c("h2", [_vm._v(_vm._s(_vm.personas.nombre))]),
                    _vm._v(" "),
                    _vm._m(4)
                  ]),
                  _vm._v(" "),
                  ...
                  _c("div", { staticClass: "full-height-scroll" }, [
                    ...
                    _c("ul", { staticClass: "list-group clear-list" }, [
                      ...
                      _c("li", { staticClass: "list-group-item" }, [
                        _c("span", { staticClass: "pull-right" }, [
                          _vm._v(
                            " " + _vm._s(_vm.personas.nombre_contacto) + " "
                          )
                        ]),
                        _vm._v(
                          "\n                                    Nombre del Contacto\n                                "
                      ...
                      _c("li", { staticClass: "list-group-item" }, [
                        _c("span", { staticClass: "pull-right" }, [
                          _vm._v(
                            " " + _vm._s(_vm.personas.cargo_contacto) + " "
                          )
                        ]),
                        _vm._v(
                          "\n                                    Cargo del Contacto\n                                "
                      ...
                      _c("li", { staticClass: "list-group-item" }, [
                        _c("span", { staticClass: "pull-right" }, [
                          _vm._v(" " + _vm._s(_vm.personas.email) + " ")
                        ]),
                        _vm._v(
                          "\n                                    Email\n                                "
                        )
                      ...
                      _c("li", { staticClass: "list-group-item" }, [
                        _c("span", { staticClass: "pull-right" }, [
                          _vm._v(" " + _vm._s(_vm.personas.celular) + " ")
                        ]),
                        _vm._v(
                          "\n                                    Celular\n                                "
                        )
                      ...
                      _c("li", { staticClass: "list-group-item" }, [
                        _c("span", { staticClass: "pull-right" }, [
                          _vm._v(" " + _vm._s(_vm.personas.direccion) + " ")
                        ]),
                        _vm._v(
                          "\n                                    Dirección\n                                "
                        )
                    ...
                    _c("hr"),
                    _vm._v(" "),
                    _c("strong", [_vm._v("Registro de Interacción")]),
                    _vm._v(" "),
                    _vm._m(6)
                  ])
                ])
            ...
            _c(
              "div",
              {
                ...
                attrs: { id: "company-" + _vm.empresas.id }
              },
              [
                _c("div", { staticClass: "m-b-lg" }, [
                  _c("h2", [_vm._v(_vm._s(_vm.empresas.razon_social))]),
                  _vm._v(" "),
                  _vm._m(7)
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "client-detail" }, [
                  _c("div", { staticClass: "full-height-scroll" }, [
                    ...
                    _vm._v(" "),
                    _c("strong", [_vm._v("Documentación Soporte")]),
                    _vm._v(" "),
                    _vm.empresas.id == 1
                      ? _c("ul", { staticClass: "list-group clear-list" }, [
                          _vm._m(14),
                    ...
                    _c("hr"),
                    _vm._v(" "),
                    _c("strong", [_vm._v("Registro de Actividad")]),
                    _vm._v(" "),
                    _vm._m(20)
                  ])
                ])
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("span", { staticClass: "text-muted small pull-right" }, [
      _vm._v("Última modificación: "),
      _c("i", { staticClass: "fa fa-clock-o" }),
      _vm._v(" 2:10 pm - 25.04.2018")
    ])
  },
  function() {
    var _vm = this
    ...
    return _c("span", { staticClass: "input-group-btn" }, [
      _c(
        "button",
        { staticClass: "btn btn btn-primary", attrs: { type: "button" } },
  ...
  function() {
    ...
    return _c("ul", { staticClass: "nav nav-tabs" }, [
      _c("span", { staticClass: "pull-right small text-muted" }, [
        _vm._v("1406 Clientes")
      ]),
      _vm._v(" "),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("td", { staticClass: "contact-type" }, [
  ...
  function() {
    ...
    return _c(
      "div",
      {
        staticClass: "vertical-container dark-timeline",
        attrs: { id: "vertical-timeline" }
      },
      [
        _c("div", { staticClass: "vertical-timeline-block" }, [
          _c("div", { staticClass: "vertical-timeline-icon gray-bg" }, [
          ...
          _c("div", { staticClass: "vertical-timeline-content" }, [
            _c("p", [
              _vm._v(
                "Llamada para confirmar el servicio.\n                                        "
              )
            ]),
            _vm._v(" "),
            _c("span", { staticClass: "vertical-date small text-muted" }, [
              _vm._v(" 2:10 pm - 12.03.2018 ")
            ])
          ])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "vertical-timeline-block" }, [
          ...
          _c("div", { staticClass: "vertical-timeline-content" }, [
            _c("p", [
              _vm._v(
                "Visita para cotización.\n                                        "
              )
            ]),
            _vm._v(" "),
            _c("span", { staticClass: "vertical-date small text-muted" }, [
              _vm._v(" 4:20 pm - 15.03.2018 ")
            ])
          ])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "vertical-timeline-block" }, [
          ...
          _c("div", { staticClass: "vertical-timeline-content" }, [
            _c("p", [
              _vm._v(
                "Revisión de documentos para generación de certificados.\n                                        "
              )
            ]),
            _vm._v(" "),
            _c("span", { staticClass: "vertical-date small text-muted" }, [
              _vm._v(" 06:10 pm - 16.03.2018 ")
            ])
          ])
        ])
      ]
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", [
      _c("small", [_vm._v("Documentación entregada: 48%")]),
      _vm._v(" "),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("li", { staticClass: "list-group-item fist-item" }, [
      _c("span", { staticClass: "pull-right" }, [
        _c("a", { staticClass: "btn btn-primary btn-xs" }, [_vm._v("Detalles")])
      ]),
      _vm._v(
        "\n                                        Barrio Guayacanes\n                                    "
      )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2002be8c", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/notificaciones.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c4d50dbe", Component.options)
  } else {
    hotAPI.reload("data-v-c4d50dbe", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
      ...
      ? _c(
          ...
          [
            _vm._l(_vm.notificaciones, function(notificacion) {
              return _c("div", { key: notificacion.id }, [
                _c("li", [
                  _c("div", { staticClass: "dropdown-messages-box" }, [
                    ...
                    _c("div", { staticClass: "media-body" }, [
                      _c(
                        "small",
                        {
                          staticClass: "pull-right badge badge-default",
                          staticStyle: { cursor: "pointer" },
                          on: {
                            click: function($event) {
              ...
              _c("div", { staticClass: "text-center link-block" }, [
                _c(
                  "a",
                  {
                    on: {
                      click: function($event) {
                        _vm.eliminarTodasNotificaciones(_vm.notificacion)
                      }
                    }
                  },
                  [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c4d50dbe", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/documentos-cliente.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-02b2fac3", Component.options)
  } else {
    hotAPI.reload("data-v-02b2fac3", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-02b2fac3", module.exports)
  }
}
